 ...
 */
final class DeferredResolutionPluginManager extends DefaultPluginManager implements DeferredResolutionPluginManagerInterface {

  /**
   * Constructs the object.
   */
  public function __construct(\Traversable $namespaces, CacheBackendInterface $cache_backend, ModuleHandlerInterface $module_handler) {
    parent::__construct('Plugin/dgi_image_discovery/url_generator/deferred', $namespaces, $module_handler, UrlGeneratorInterface::class, DeferredResolution::class);
